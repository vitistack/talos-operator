...
func Init() {
	...
	viper.SetDefault(consts.TALOS_VERSION, "v1.12.4")
	viper.SetDefault(consts.DEFAULT_KUBERNETES_VERSION, "1.35.0")
	viper.SetDefault(consts.TALOS_VM_INSTALL_IMAGE_KUBEVIRT, "factory.talos.dev/metal-installer/e52572396b329a850cf08baad906b367609f7e12e778c2073503751d018e429c:v1.12.4")
	viper.SetDefault(consts.TALOS_VM_INSTALL_IMAGE_DEFAULT, "factory.talos.dev/metal-installer/e52572396b329a850cf08baad906b367609f7e12e778c2073503751d018e429c:v1.12.4")
	...
	viper.SetDefault(consts.BOOT_IMAGE, "https://factory.talos.dev/image/e52572396b329a850cf08baad906b367609f7e12e778c2073503751d018e429c/v1.12.4/metal-amd64.iso")
