...
func Init() {
	...
	viper.SetDefault(consts.TALOS_VERSION, "v1.25.5")
	...
	viper.SetDefault(consts.BOOT_IMAGE, "https://factory.talos.dev/image/e52572396b329a850cf08baad906b367609f7e12e778c2073503751d018e429c/v1.25.5/metal-amd64.iso")
